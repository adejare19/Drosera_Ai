...
//     .then(() => {
//       const temp = codeEl.innerText;
//       codeEl.innerText = "Copied!";
//       setTimeout(() => codeEl.innerText = temp, 1000);
//     })
//     .catch(err => {
...
// // Function to handle asking the AI for help
// async function askAI() {
//   const errorText = document.getElementById('errorBox').value.trim();
//   if (!errorText) {
//     alert("Please describe the error you encountered.");
//     return;
//   }
...
//       body: JSON.stringify({
//         username: localStorage.getItem('discordUsername') || 'anonymous',
...
//       j = JSON.parse(txt);
//     } catch (e) {
//       console.error('Invalid JSON from AI:', e, txt);
...
// // Renders the current step from the local JSON file
